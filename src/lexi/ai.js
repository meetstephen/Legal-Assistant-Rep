...
//   1. Personal apiKey supplied → direct call to Gemini API
//      (non-admin users who entered their own key in Settings)
//   2. No personal key + USE_PROXY=true → /api/gemini
//      (admin whose key lives in a server-side env var)
//   3. Neither → throws so the caller shows "add your key" prompt
// ============================================================
