...
export function JurisdictionFields({ scope, onChange }) {
  const update = (key, value) => onChange({ ...scope, [key]: value });
  return <div className="space-y-2">
    <div className="grid sm:grid-cols-2 gap-3">
      <Select label="Matter jurisdiction * (all states + FCT)" value={scope.jurisdiction} onChange={e => update('jurisdiction', e.target.value)}
